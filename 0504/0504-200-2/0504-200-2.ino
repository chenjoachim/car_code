...
void adjust(){
  ...
  if(cnt == 0)
  {
    ...
    else if((turn_mode_cur==RIGHT)||(turn_mode_cur==RETURN))MotorWrite(-60, 70);
    ...
    if (cnt <= 3){
      ...
      turning = 0;
      double V_sR = 209; // the velocity of going straight (CHANGE HERE!)
      double V_sL = 200; 
      double K_p = 40; // P control term (CHANGE HERE!)
      ...
      MotorWrite(209,200);
      delay(530); // keep going until reach the RFID.
