...
void loop() { 
  ...
  while(BT.available())
  {
    ...
    else
    {
      ...
      if(ss=="R")turn_mode_input[cnt_step_input]=RIGHT;
      else if(ss=="L")turn_mode_input[cnt_step_input]=LEFT;
      else if(ss=="RE")turn_mode_input[cnt_step_input]=RETURN;
      else if(ss=="ST")turn_mode_input[cnt_step_input]=STRAIGHT;
      cnt_step_input++;
    }
  }
  switch(cur_mode)
